...
for pair in "${lambdas[@]}"; do
    ...
    torchrun --nproc_per_node=2 train.py \
        ...
        --latent-dct \
        --latent-dct-grps "1" \
        --run-name "sar-pact/g8_alpha1.0_gamma1.0_latentdct1x320"
    ...
    torchrun --nproc_per_node=2 train.py \
        ...
        --latent-dct \
        --latent-dct-grps "1" \
        --checkpoint "/scratch/zb7df/models/sar-pact/g8_alpha1.0_gamma1.0_latentdct1x320/nga/lambda_${lmbda1}.pth.tar" \
        --run-name "sar-pact/g8_alpha0.01_gamma1.0_latentdct1x320"
